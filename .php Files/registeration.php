...
<body>
    <form name="myform" action="insertr.php" method="post" onsubmit="return formvalid();"><br><br>
<div class="row">
      <div class="col-25">
        <label for="fn">First Name</label>
      </div>
      <div class="col-75">
        <input type="text" id="fn" name="fn" placeholder="Your name..">
      </div>
    </div>
<div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="mn" name="mn" placeholder="Your name..">
      </div>
    </div>
...
<div class="row">
      ...
      <div class="col-75">
        <input type="text" id="ln" name="ln" placeholder="Your last name..">
      </div>
    </div>
<div class="row">
      <div class="col-25">
